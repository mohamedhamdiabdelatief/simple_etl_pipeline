...
echo "\c template1;\COPY access_log  FROM '/etl_dir/shell scripting etl project/transformed-data.csv' DELIMITERS ',' CSV HEADER;" | psql --username=postgres --host=localhost
